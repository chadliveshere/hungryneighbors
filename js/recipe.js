...
const buildRecipe = (item) => {
	...
	const recipeClassNames = {
		...
		titleContainer: 'recipe__title-container column align-self-center large-4 large-offset-2 large-order-0 medium-12 medium-order-1 medium-offset-0 small-12 small-order-1 small-offset-0',
		imageContainer: 'recipe__image column large-6 large-order-1 medium-12 medium-order-0 small-12 small-order-0',
		...
		instructions: 'recipe__instructions column large-6 large-offset-1 small-12 small-offset-0',
	};
